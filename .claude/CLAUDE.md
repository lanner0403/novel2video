...
| `location_cards` | 場地卡產生 | `locations.json` | LLM | `stages_text.run_location_cards` |
...
GET  /api/projects/{pid}/locations                   # 專案共用場地卡
PUT  /api/projects/{pid}/locations/{name}            # 編輯單一場地卡欄位
